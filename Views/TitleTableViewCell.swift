...
//  Netflix Clone
//
//  Created by Vũ Hoàng Tùng on 2/6/25.
//
...
class TitleTableViewCell: UITableViewCell {
    ...
    private func applyConstraints() {
        let titlePosterUIImageViewConstraints = [ titlePosterUIImageView.leadingAnchor.constraint(equalTo: contentView.leadingAnchor),
